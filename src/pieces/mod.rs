...
#[allow(clippy::non_cannoical_partial_ord_impl)]
impl PartialOrd for PieceType {
    fn partial_cmp(&self, other:&Self) -> Option<Ordering> {
        ...
        match (self, other) {
            ...
            (PieceType::Bishop, PieceType::Knight) => Some(Ordering::Greater),
            (PieceType::Bishop, PieceType::Rook) => Some(Ordering::Less),
            (PieceType::Knight, PieceType::Rook) => Some(Ordering::Less),
            (PieceType::Knight, PieceType::Bishop) => Some(Ordering::Less),
